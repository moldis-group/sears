...
output_root = "geoms"      # in the folder 'geoms' multiple folders will be created with same name as molecule_id in the second column of "file.smi". Each folder  will contain rdkit_guess.sdf
...
with open(input_file, "r") as f:
    ...
    for line in f:
        ...
        # ----- write SDF into its own folder -----
        mol_folder = os.path.join(output_root, name)
        os.makedirs(mol_folder, exist_ok=True)

        out_path = os.path.join(mol_folder, "rdkit_guess.sdf")
